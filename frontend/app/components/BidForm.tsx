      ...
      <div className="px-5 py-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 mb-6">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-gray-900">{property.apartmentName}</span>
            </div>
            <div className="flex justify-between">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xl font-bold text-green-600">
                  {(parseFloat(formData.commission) * 12.5 * 100000000 / 100).toLocaleString()}원
                </span>
              </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 py-4 bg-green-600 text-white rounded-lg font-semibold"
            >
              지원하기
            </button>
          </div>
